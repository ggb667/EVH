...
- active subtask: stockroom rollout planning state captured; waiting on Instinct-human response to the emailed migration/API/data-model questions before refining the pilot and ownership matrix further
