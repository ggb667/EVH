...
from scripts.instinct_cache_sync_pipeline import connect_db, emit, sync_patients
from scripts.instinct_identity_sync import InstinctApiSyncClient


def main() -> int:
    parser = argparse.ArgumentParser(description="Step 1.2: sync Instinct patients into the patient cache")
    ...
    parser.add_argument("--log-file", default="etl_logs/instinct_step1_2_patients.log")
    ...
    with log_path.open("a", encoding="utf-8") as logf:
        ...
        emit(log, "step_start", step="1.2", log_file=str(log_path))
        ...
        emit(log, "step_done", step="1.2", **summary.__dict__)
    return 0
