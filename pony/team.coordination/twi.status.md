...
BRANCH_VERIFIED: yes
STATUS: READY
PUSH_STATUS: local_commit_pending
...
BLOCKERS: none
NEXT_STEP: commit the reconciled local changes, verify the worktree is clean, then resume normal coordination from the EVH project state
